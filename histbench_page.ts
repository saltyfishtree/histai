 ...
 */
import { DATASET_LINK } from './config';
        ...
        <div class="container">
            ...
            <section class="content-section">
                ...
                <div class="image-placeholder-container">
                    <img src="https://whale-memory.oss-cn-shanghai.aliyuncs.com/test/histagent/resource/HistBenchDifficulty.png" alt="${t('histbench.difficulty_levels.img_alt')}" class="content-image">
                ...
                <div class="image-placeholder-container">
                    <img src="https://whale-memory.oss-cn-shanghai.aliyuncs.com/test/histagent/resource/geographicCoverage.png" alt="${t('histbench.linguistic_diversity.map_alt')}" class="content-image">
                ...
                <div class="image-placeholder-container">
                    <img src="https://whale-memory.oss-cn-shanghai.aliyuncs.com/test/histagent/resource/pipeline.png" alt="${t('histbench.review_pipeline.img_alt')}" class="content-image">
