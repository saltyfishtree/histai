    ...
    return `
        <div class="container">
            ...
            <section class="content-section">
                ...
                <div>
                    <img src="https://whale-memory.oss-cn-shanghai.aliyuncs.com/test/histagent/resource/historycomplexity.png" alt="${t('histagent.needs.img_alt')}" class="content-image">
                </div>
            ...
            <section class="content-section">
                ...
                <div class="image-placeholder-container">
                    <img src="https://whale-memory.oss-cn-shanghai.aliyuncs.com/test/histagent/resource/histagent_architecture.png" alt="${t('histagent.tackling.img_alt')}" class="content-image">
